...
const PageHero = ({ title, subtitle, breadcrumb = [], bgImage }) => {
  return (
    <div className="page-hero-bg pt-20">
      ...
      {/* Content wrapper with relative z-10 to stay above bgImage */}
      <div className="relative z-10 container-custom py-16 md:py-20">
        ...
        <motion.div
          ...
          className="max-w-3xl"
        >
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight drop-shadow-md">
            {title}
          </h1>
          {subtitle && (
            <p className="text-teal-50 font-sans text-lg md:text-xl leading-relaxed drop-shadow">
              {subtitle}
            </p>
          )}
        </motion.div>
      ...
      {/* Wave bottom */}
      <div className="relative z-10 h-12 overflow-hidden mt-[-1px]">
